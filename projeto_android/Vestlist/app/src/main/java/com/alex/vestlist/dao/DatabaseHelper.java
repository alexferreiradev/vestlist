...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String PRIMARY_KEY_SQL_STRING = " integer auto increment primary key, ";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTablesString =
                ...
                VestListContract.ListEntry.STATUS_COLLUNM + " integer(1) true, " +
        ...
        db.execSQL(createTablesString);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String deleteTablesString =
